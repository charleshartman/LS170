...
1. "Hello server, I would like to connect to your **securely**. This is my maximum TLS version and here is the cipher suites I have available to me."
2. "Great, here is my Public Key Certificate, signed by the relevant authorities, so you know it's really me. And let's use this particular cipher suite. Now use that cipher suite and send me a message (pre-master secret) encrypted with my public key."
3. "Cool, here is that message encrypted with your public key. I'm on board with these other parameters to apply when generating our symmetric key."
4. "OK, I have decrypted your message (pre-master secret), I've used that and the parameters we agreed on to generate the same encryption key as you. Now we will communicate using that key for all future exchanges."
